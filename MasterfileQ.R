...
Raw.MF <- lapply(c(6,7),function(x)load_excel("/Volumes/AC/SUPPORT_STAFF/SUPPORT_STAFF/Reports/Queue Type Reports/AHT & CSAT Masterfile per QT_20180418.xlsx",sheet=x)) #Load Masterfile QT AHT and CSAT tabs
